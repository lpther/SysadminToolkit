...
class PluginTestCase(unittest.TestCase):
    ...
    def test_bad_instanciation_types(self):
        self.assertRaises(exception.CommandPromptError, plugin.Plugin, None, None)

    def test_correct_instanciation(self):
        self.assertTrue(plugin.Plugin('testcase-plugin', self.nulllogger), None)

    def test_basic_properties_getters_setters(self):
        pluginname = 'testcase-plugin'

        testplugin = plugin.Plugin('testcase-plugin', self.nulllogger)
